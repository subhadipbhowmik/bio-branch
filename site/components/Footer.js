    ...
    <footer aria-label="Site Footer" className="relative bg-gray-900 text-white py-10 px-6">
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between relative z-10 space-y-8 md:space-y-0">
        ...
        <div className="flex space-x-6 md:order-2">
          <Link href="https://twitter.com/yourprofile" target="_blank" aria-label="Twitter" className="text-gray-400 hover:text-[#1DA1F2] transition transform hover:scale-110">
            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              {/* Updated Twitter X SVG Path*/}
          ...
          <Link href="https://www.linkedin.com/in/shubhadip-bhowmik/" target="_blank" aria-label="LinkedIn" className="text-gray-400 hover:text-[#0077B5] transition transform hover:scale-110">
            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="https://github.com/subhadipbhowmik/bio-branch" target="_blank" aria-label="GitHub" className="text-gray-400 hover:text-gray-800 transition transform hover:scale-110">
            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="https://instagram.com/yourprofile" target="_blank" aria-label="Instagram" className="text-gray-400 hover:text-[#E1306C] transition transform hover:scale-110">
            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
