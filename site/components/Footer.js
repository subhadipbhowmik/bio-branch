...
const Footer = () => {
  return (
    <footer aria-label="Site Footer" className="bg-gray-900 text-white py-4">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
        <Link href="https://shubhadip.bio.link" target="_blank">
          <img src="/images/favicon.ico" alt="Shubhadip's Bio Link" className="h-8 w-8" />
        </Link>
        <p className="text-sm mt-3 md:mt-0">&copy; 2024 Shubhadip Bhowmik</p>
        <div className="flex space-x-4 mt-3 md:mt-0">
          <Link href="https://twitter.com/yourprofile" target="_blank" aria-label="Twitter" className="hover:text-blue-400">
          ...
          <Link href="https://linkedin.com/in/yourprofile" target="_blank" aria-label="LinkedIn" className="hover:text-blue-600">
            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="https://github.com/yourprofile" target="_blank" aria-label="GitHub" className="hover:text-gray-400">
            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
