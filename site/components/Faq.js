      ...
      <div className="space-y-8">
        {faqData.map((faq, index) => (
          <div key={index} className="faq-item-container">
            <div
              className={`bg-white rounded-lg shadow-lg p-6 flex flex-col transition-transform transform cursor-pointer 
                hover:scale-105 hover:shadow-xl hover:bg-gray-50 duration-300 ease-in-out
